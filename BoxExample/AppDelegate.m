...
didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [BOXContentClient setClientID:@"kt0385eo2xm18qpx0bhmglnfajpnqklp"
                     clientSecret:@"bV4sJqYoPwexQqjhk3oryN0rUeeLJjit"];

        //    BOXAuthenticationPickerViewController *authenticationController =
        //    [[BOXAuthenticationPickerViewController alloc]init];
        //    UINavigationController *navController = [[UINavigationController alloc]
        //    initWithRootViewController:authenticationController];
        //    self.window.rootViewController = navController;
        //    [self.window makeKeyAndVisible];
    BOXSampleAccountsViewController *authenticationController =
    [[BOXSampleAccountsViewController alloc] init];
    UINavigationController *navController = [[UINavigationController alloc]
                                             initWithRootViewController:authenticationController];
    self.window.rootViewController = navController;
    [self.window makeKeyAndVisible];
...
- (NSURL *)applicationDocumentsDirectory {
        ...
        // code uses a directory named "com.example.BoxExample" in the application's
        // documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"BoxExample"
                                              withExtension:@"momd"];
    _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory]
                       URLByAppendingPathComponent:@"BoxExample.sqlite"];
    NSError *error = nil;
